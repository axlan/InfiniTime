...
#include "displayapp/screens/WatchFaceTree.h"
...
std::unique_ptr<Screen> Clock::WatchFaceTreeScreen() {
  return std::make_unique<Screens::WatchFaceTree>(dateTimeController,
                                                  batteryController,
                                                  bleController,
                                                  notificationManager,
                                                  settingsController,
